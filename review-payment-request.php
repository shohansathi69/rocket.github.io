...
<div class="container-fluid">
  ...
  <?php if ($user_row['status']=="0") {
    ...
    <Button type='submit' style='background: red;border: none;' class='btn btn-success btn btn-primary btn-block'> Block User</Button>";
  }else {
      echo "
...
<button type='submit' class='btn btn5 btn-primary btn-block btn-success mb-3'><i class='fa-solid  fa-check'></i> Approve</button>
</form>
...
<button type='submit' class='btn btn5 btn-primary btn-block btn-danger mb-3'><i class='fa-solid fa-xmark'></i> Reject</button>
</form>
<form>
<a  href='user-track.php?i=$user' class='btn btn5 btn-primary btn-block btn-secondary'><i class='fa-solid fa-eye'></i> User Track</a>
</form>
</div>
...
<div class="row justify-content-center">
  ...
  <div class="activity_wrap" style="display: flex; flex-direction: row;">
  <h6>User Country:&nbsp;&nbsp;</h6>
  <h6><?php echo $user_row['UserCountry']; ?></h6>
  </div>
  </div>
  ...
  <div class="activity_wrap" style="display: flex; flex-direction: row;">
  <h6>Device Id:&nbsp;&nbsp;</h6>
  <h6><?php echo $user_row['device']; ?></h6>
  </div>
  </div>
